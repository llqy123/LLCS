...
def train_one_epoch(vfm_model, noun_embeddings, model, method, data, loss, epoch, optimizer, scaler, scheduler, dist_model, args):
    ...
    for i, batch in enumerate(dataloader):
        ...
        with autocast():
            losses, batch_size, logit_scale = method(batch, model, vfm_model, noun_embeddings, dist_model, loss, device, cast_dtype,
