torchrun --nproc_per_node 2  --master_port 29600 -m training.main --batch-size=2 --lr=1e-5 --wd=0.1 --epochs=6 --workers=4 \
...
--name logs_dinov2_vit_base_16 --downsample-factor 16 --det-image-size 1024 \
--alpha 0.7 --train-embed-path metadata/coco_nouns_4764_clip_hand_craft_EVACLIP_ViTB16.npy --lsl-weight 0.1 --csl-weight 0.3 --vfm-type dinov2-B
