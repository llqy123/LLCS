...
--name logs_dino_vit_base_8 --downsample-factor 16 --det-image-size 1024 \
--alpha 0.7 --train-embed-path metadata/coco_nouns_4764_clip_hand_craft_EVACLIP_ViTB16.npy --lsl-weight 0.1 --csl-weight 0.3 --vfm-type dino-B-8
