torchrun --nproc_per_node 2 -m training.main --batch-size=2 --lr=1e-5 --wd=0.1 --epochs=6 --workers=4 \
...
--name logs_sam_vit_large_14 --downsample-factor 14 --det-image-size 896 \
--alpha 0.95 --train-embed-path metadata/coco_nouns_clip_hand_craft_EVACLIP_ViTL14x336.npy --lsl-weight 0.1 --csl-weight 0.3 --vfm-type sam-L
